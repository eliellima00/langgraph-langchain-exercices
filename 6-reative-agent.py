...
with open("6-reative-agent.png", 'wb') as f:
  f.write(img_bytes)


result = graph.invoke({"messages": HumanMessage(content="Me traga todos os dados do cliente Eliel e a soma dos produtos comprados")})
